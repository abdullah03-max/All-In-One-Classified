...
const ListingForm: React.FC<ListingFormProps> = ({ listing, onSuccess }) => {
  ...
  useEffect(() => {
    if (isServicesCategory || isJobsCategory) {
      setValue('price', 0);
      setValue('is_negotiable', false);
    }
  }, [isServicesCategory, isJobsCategory, setValue]);
          ...
          <div className="space-y-6">
            <div className="card p-6 space-y-5">
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 pb-2 border-b border-slate-100 dark:border-slate-700">
                {isServicesCategory || isJobsCategory ? 'Location' : 'Pricing & Location'}
              </h2>
                ...
                <div className="p-5 space-y-4">
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      {!isServicesCategory && !isJobsCategory && watch('is_negotiable') && (
